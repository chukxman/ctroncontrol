    ...
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
      <div class="mdc-card info-card info-card--success">
        <div class="card-inner">
          ...
          <h5 class="font-weight-light pb-2 mb-1 border-bottom"><a href="#channel1counter" data-bs-toggle="modal" class="small-box-footer">Set counter</a></h5>
          {{-- Modal for counter --}}
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {{-- <form action="{{ route('updateChannel1CounterE', [$devices->id]) }}" method="POST" id="modal-details[5]"> --}}
                    @csrf
                    @method('PUT')
          ...
          <h5 class="font-weight-light pb-2 mb-1 border-bottom">Switched by: @if($devices->channel1controlsource == 1)
            {{"Manual"}}
            ...
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel1StateE', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
                    <input type="checkbox" id="basic-switch" class="mdc-switch__native-control" role="switch" name="channel1state" onchange="this.form.submit()" {{ $devices->channel1state ? 'checked' : '' }}>
                  </form>
                </div>
              </div>
            </div>                    
    ...
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
      <div class="mdc-card info-card info-card--danger">
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel2counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {{-- <form action="{{ route('updateChannel2CounterE', [$devices->id]) }}" method="POST" id="modal-details[6]"> --}}
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <h5 class="font-weight-light pb-2 mb-1 border-bottom">switched by:@if($devices->channel2controlsource == 1)
            {{"Manual"}}
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel2StateE', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
    ...
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
      <div class="mdc-card info-card info-card--primary">
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel3counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {{-- <form action="{{ route('updateChannel3CounterE', [$devices->id]) }}" method="POST" id="modal-details[7]"> --}}
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <h5 class="font-weight-light pb-2 mb-1 border-bottom">Switched by:@if($devices->channel3controlsource == 1)
            {{"Manual"}}
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel3StateE', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
    ...
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
      <div class="mdc-card info-card info-card--info">
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel4counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {{-- <form action="{{ route('updateChannel4CounterE', [$devices->id]) }}" method="POST" id="modal-details[8]"> --}}
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <h5 class="font-weight-light pb-2 mb-1 border-bottom">Switched by:@if($devices->channel4controlsource == 1)
            {{"Manual"}}
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel4StateE', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('updateChannel1ScheduleE', [$devices->id]) }}" method="POST" id="modal-details[1]">
                              @csrf
                              @method('PUT')
                                  <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel2schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel2schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel2ScheduleE', [$devices->id]) }}" method="POST" id="modal-details[2]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel3schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel3schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel3ScheduleE', [$devices->id]) }}" method="POST" id="modal-details[3]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel4schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel4schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel4ScheduleE', [$devices->id]) }}" method="POST" id="modal-details[4]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
