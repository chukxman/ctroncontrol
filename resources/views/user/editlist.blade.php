                        ...
                        <table class="table table-striped">
                          ...
                          @foreach($devices as $device)
                            <tr>
                              ...
                              <td>
                                  <button type="button" class="btn btn-primary btn-icon-text" onclick="location.href='{{ route('user.edit', $device->id) }}'"> Edit</button>
                              </td>
                            </tr>
                            @endforeach
                          </tbody>
                    ...
                    <div class="table-responsive  mt-1">
                      ...
                      @foreach($subusers as $user)
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-danger btn-icon-text" onclick="location.href='{{ route('subuser.destroy', $user->id) }}'">Delete</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
