            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('updateChannel1CounterS', [$devices->id]) }}" method="POST" id="modal-details[5]">
                    @csrf
                    @method('PUT')
            ...
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel1StateS', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
        ...
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel2counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('updateChannel2CounterS', [$devices->id]) }}" method="POST" id="modal-details[6]">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel2StateS', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
        ...
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel3counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('updateChannel3CounterS', [$devices->id]) }}" method="POST" id="modal-details[7]">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel3StateS', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
        ...
        <div class="card-inner">
          ...
          <div class="modal fade" id="channel4counter">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('updateChannel4CounterS', [$devices->id]) }}" method="POST" id="modal-details[8]">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
          ...
          <div class="card-icon-wrapper">
            <div class="mdc-switch mdc-switch--light" data-mdc-auto-init="MDCSwitch">
              ...
              <div class="mdc-switch__thumb-underlay">
                <div class="mdc-switch__thumb">
                  <form method="POST" action="{{ route('updateChannel4StateS', [$devices->id]) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <td>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('updateChannel1ScheduleS', [$devices->id]) }}" method="POST" id="modal-details[1]">
                              @csrf
                              @method('PUT')
                                  <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel2schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel2schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel2ScheduleS', [$devices->id]) }}" method="POST" id="modal-details[2]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel3schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel3schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel3ScheduleS', [$devices->id]) }}" method="POST" id="modal-details[3]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
                      ...
                      <div class="modal fade" id="channel4schedule" tabindex="-1" role="dialog" aria-bs-labelledby="channel4schedule" aria-bs-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('updateChannel4ScheduleS', [$devices->id]) }}" method="POST" id="modal-details[4]">
                                @csrf
                                @method('PUT')
                                    <div class="form-group row">
