...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.update',$device->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="location" class="form-control" value="{{ $device->location }}" placeholder="Enter Location">
        </div>
        <div class="form-group">
            <label for="user_id">User ID:</label>
            <input type="text" name="user_id" class="form-control" value="{{ $device->usr_id }}" placeholder="Enter User ID">
        </div>
